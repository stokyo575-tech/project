...
async function startVoiceRecording() {
    try {
        ...
        mediaRecorder.onstop = () => {
            ...
            msg.innerHTML = `<div class="audio-message"><i class="fas fa-microphone"></i> Voice Note<br><audio controls style="width: 100%; max-width: 300px;"><source src="${audioUrl}" type="audio/wav">Your browser does not support audio.</audio></div>`;
